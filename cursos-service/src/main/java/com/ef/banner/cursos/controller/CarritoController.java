...
public class CarritoController {
	...
	public ResponseEntity<Carrito> obtenerUltimoCarritoPagado(@PathVariable Long usuarioId) {
	    return ResponseEntity.ok(carritoService.obtenerUltimoCarritoPagadoPorUsuarioId(usuarioId));
	}
